            ...
            <div className="bg-white shadow rounded-lg">
              <div className="px-4 py-5 sm:p-6">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <Link href="/department/approvals" className="text-sm font-medium text-blue-600 hover:text-blue-500">
                    View all
                  </Link>
                </div>
                    ...
                    {recentStudents.map((student) => (
                      ...
                      >
                        ...
                        <div className="flex items-center space-x-3">
                          ...
                          <Link href={`/department/students/${student.id}`} className="text-blue-600 hover:text-blue-500">
